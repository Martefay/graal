...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['autocomplete' => 'off','inline-prefix' => true,'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('filament-panels::global-search.field.placeholder')),'type' => 'search','wire:key' => 'global-search.field.input','x-bind:id' => '$id(\'input\')','x-on:keydown.down.prevent.stop' => '$dispatch(\'focus-first-global-search-result\')','x-data' => '{}','attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(
                \Filament\Support\prepare_inherited_attributes(
                    new \Illuminate\View\ComponentAttributeBag([
                        'wire:model.live.debounce.' . $debounce => 'search',
                        'x-mousetrap.global.' . collect($keyBindings)->map(fn (string $keyBinding): string => str_replace('+', '-', $keyBinding))->implode('.') => $keyBindings ? 'document.getElementById($id(\'input\')).focus()' : null,
...
<?php /**PATH D:\Assets\laravelAPP\DanilinCosmetics\vendor\filament\filament\src\/../resources/views/components/global-search/field.blade.php ENDPATH**/ ?>