...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/image/circular_logo.png')); ?>" type="image/x-icon">
...
<body class="bg-black text-white">
    <div id="preloader" class="fixed inset-0 bg-white z-50 flex items-center justify-center transition-opacity duration-500 object-cover bg-[url(<?php echo e(asset('assets/image/BG.png')); ?>)]">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2436078167-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2436078167-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2436078167-2', $__slots ?? [], get_defined_vars());
